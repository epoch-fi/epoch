...
const TradingChart = ({ data }: Props) => {
  ...
  useEffect(() => {
    ...
    if (data && chartRef.current) {
      ...
      const areaSeries = chart.addAreaSeries({
        lineColor: "#32CD32",
        topColor: "#32CD32",
        bottomColor: "rgba(46, 139, 87, 0.28)",
      });
      areaSeries.setData(tempData);
      ...
      toolTip.style.borderColor = "#32CD32";
      toolTip.style.transition =
        "top 0.1s ease-in-out, left 0.1s ease-in-out, right 0.1s ease-in-out, bottom 0.1s ease-in-out";
      ...
      chart.subscribeCrosshairMove((param) => {
        ...
        if (
          ...
          toolTip.innerHTML = `<div style="color: ${"#32CD32"}; font-weight: bold">Apple Inc.</div><div style="font-size: 20px; margin: 4px 0px; color: ${"white"}">
  ...
  return <div ref={chartRef} id="container" className="relative w-full"></div>;
};
